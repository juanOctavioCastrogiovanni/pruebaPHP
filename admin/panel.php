...
if(isset($_GET['id'])){ 
        $con = conectar();
        $sql = "SELECT blogs.id,titulo,fecha,docentes.nombre AS nombre,apellido,imagen, catedras.nombre AS nombreCatedra FROM blogs INNER JOIN catedras INNER JOIN docentes ON docentes.id=".$_GET['id']."";
